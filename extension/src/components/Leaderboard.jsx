...
const RANK_ORDER = ["Noob", "Beginner", "Developing", "Average", "Skilled", "Proficient", "Advanced", "Elite", "Expert", "Master", "Grandmaster", "Legendary", "Mythic", "Transcendent", "Omniscient"];
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%" }}>
            <h3 style={{ margin: 0, fontSize: "13px", letterSpacing: "2px", textTransform: "uppercase", opacity: 0.6 }}>Leaderboard</h3>
            <FaTimes
              onClick={() => setOpen((o) => !o)}
                        ...
                        >
                          ...
                          <td className="col-player">
                            <div className="player-info">
                              ...
                              <span className={`player-name ${isMe && "you-badge"}`}>{entry.email?.split("@")[0] || "?"}</span>
                            </div>
                          </td>
