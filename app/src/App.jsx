...
import { FaSyncAlt, FaLowVision, FaCloudSun, FaCalculator } from "react-icons/fa";

import { auth, analytics } from "./firebase";
import { onAuthStateChanged } from "firebase/auth";
import { logEvent } from "firebase/analytics";

import { Login, User, Board, Numpad, Typing, ColorSettings, SoundSettings, Leaderboard, Loading, AdBanner } from "./components/index";
  ...
  return (
    ...
    >
      ...
      <div id="keyboard-header-container">
        <div id="keyboard-logo">{menu && <h3 className="header">BoardCheck</h3>}</div>
      ...
      <div id="keyboard-section">
        <Board
          ...
          setRealTimeKeys={setRealTimeKeys}
          persistentKeys={persistentKeys}
          setPersistentKeys={setPersistentKeys}
          sound={sound}
          colors={colors}
